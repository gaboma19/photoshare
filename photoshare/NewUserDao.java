...
public class NewUserDao {
  ...
  private static final String NEW_USER_STMT = "INSERT INTO " +
      "\"Users\" (email, password, fname, lname, dob, gender, city, state, country, location, education) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

  public boolean create(String email, String password, String fname, String lname, Date dob, String gender, String city, String state, String country, String location, String education) {
